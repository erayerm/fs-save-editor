...
const SIZE = 24; // marker size in px

const GREEN_STROKE = '#0e9b43'; // darker green outline for the filled active heart
 ...
 * shows a filled Fallout-green heart. Relies on the parent cell carrying the `group`
  ...
  return (
    ...
    >
      <svg width={SIZE} height={SIZE} viewBox="0 0 24 24" className="block">
        <path
          d={HEART_PATH}
          fill={active ? FALLOUT_GREEN : 'none'}
          stroke={active ? GREEN_STROKE : '#a1a1aa'}
